...
@test "run release script from develop without snapshot" {
	...
	./release-scripts/release.sh 23.1 --without-snapshot
...
@test "run hotfix from develop without snapshot" {
	...
	./release-scripts/hotfix_start.sh 23.1.1 --without-snapshot
  ...
  # ------------------------- FINISH HOTFIX -------------------------
	...
	./release-scripts/hotfix_finish.sh 23.1.1 --without-snapshot
